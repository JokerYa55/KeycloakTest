...
public class mainPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        log.log(Level.INFO, "query = {0}", request.getQueryString());
        log.log(Level.INFO, "attr = {0}", attr.nextElement());
        /*while (!attr.hasMoreElements()) {
            System.out.println("req = " + attr.nextElement());            
            log.info("req = " + attr.nextElement());
        }*/
